...
const items = [
  ...
  },
  {
    ...
    description:
      'The platform is available on all devices, including mobile, desktop, and tablet.',
    ...
    <Container id="features"  sx={{ py: { xs: 8, sm: 16} }}>
      <Grid container spacing={6} >
        <Grid item xs={12} md={10}>
          <div>
            <Typography component="h2" variant="h4" color="text.primary" alignItems={'center'}>
              Features
            </Typography>
            <Typography
              variant="body1"
                  ...
                  <div>
                    ...
                    <Link
                      ...
                      sx={{
                        ...
                        alignItems: 'center',
                        '& > svg': { transition: '0.3s' },
                        '&:hover > svg': { transform: 'translateX(15px)' },
                      }}
                      onClick={(event) => {
